(function ( $ ){
	...
	*/
	...
	var defaultKey		= '84KOAL0AQ2mG6mhUdVpACUCgwnjETVD61jL1tf5xLkwj2yX8', // Unique master Xively API key to be used as a default
		...
		dataDuration	= '31days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 1800, // Default interval for data to be displayed (in seconds)
		dataColor		= '69ab35', // CSS HEX value of color to represent data (omit leading #)
